  ...
  return (
    ...
    >
      <div className="flex gap-2 sm:4 flex-col items-center">
        <Link
          to={"/pos/menu"}
          className="block px-1  border-b py-[6px] sm:py-3"
        >
          {isMobile ? (
            <img src="/images/logo_bg.png" className="w-10" alt="" />
          ) : (
            <Logo width={45} />
          )}
        </Link>
      ...
      <div className="rounded-full my-4 sm:my-2 -ml-[5px] p-[2px] border-primary border-2 ">
